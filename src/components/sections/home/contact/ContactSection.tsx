        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full max-w-6xl">
          ...
          >
            ...
            <div className="space-y-4">
              <SectionTitleText wrapperClassName='items-start'>
                <span className="text-blue-600">Contact Us</span>
              </SectionTitleText>
              <PageHeading 
                wrapperClassName="items-start" 
                className="text-4xl lg:text-5xl text-gray-900 mb-4 text-left"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors duration-200 resize-none"
